...
function areMetricsEqual(next: ScrollbarMetrics, previous: ScrollbarMetrics) {
  return (
    next.hasVerticalOverflow === previous.hasVerticalOverflow &&
    next.headerHeight === previous.headerHeight &&
    next.horizontalScrollbarSize === previous.horizontalScrollbarSize &&
    next.thumbHeight === previous.thumbHeight &&
    next.thumbTop === previous.thumbTop &&
...
const DataGridScrollArea = ({
  ...
  const resetMetrics = useCallback(() => {
    ...
    setHasCustomVerticalOverflow((previous) => (previous ? false : previous))
  }, [])
  ...
  const syncCustomVerticalScrollbar = useCallback(() => {
    ...
    setHasCustomVerticalOverflow((previous) =>
      previous === nextMetrics.hasVerticalOverflow
        ? previous
