...
declare module "@tanstack/react-table" {
  ...
  interface ColumnMeta<TData extends RowData, TValue> {
    ...
    /**
     * When true (and `tableLayout.width === "fixed"`), the column's width is
     * left to the browser so it expands to consume whatever horizontal space
     * the fixed-width columns leave behind. Use this for "free text" columns
     * (names, addresses, descriptions) that should absorb the remainder while
     * siblings stay pinned to explicit pixel sizes via `size`.
     */
    flex?: boolean
  }
}
